...
export const metadata: Metadata = {
  title: "Politique de Confidentialité - frsitesdeparissportifs",
  description:
    "Comment frsitesdeparissportifs protège vos données et respecte votre vie privée. 18+ - Jouez responsable.",
  robots: {
    index: true,
    follow: true,
  },
            ...
            <div className="space-y-8 text-foreground">
              <section className="bg-primary/5 p-6 rounded-lg border-l-4 border-primary">
                <p className="text-muted-foreground leading-relaxed">
                  Le site <strong>frsitesdeparissportifs</strong> est la propriété de et est exploité par <strong>Sigmastart04 GmbH</strong> (Zehmeplatz 14, 15230 Frankfurt, Deutschland). Nous prenons très au sérieux la protection de vos données
              ...
              <section>
                ...
                <div className="bg-muted/30 p-4 rounded-lg">
                  <p className="text-muted-foreground leading-relaxed mb-3">
                    Le site frsitesdeparissportifs.com est la propriété de et est exploité par <strong>Sigmastart04 GmbH</strong>,
                    responsable du traitement de vos données personnelles.
                  </p>
                  <p className="text-muted-foreground text-sm font-medium mb-1">Sigmastart04 GmbH</p>
                  <p className="text-muted-foreground text-sm">Zehmeplatz 14</p>
                  <p className="text-muted-foreground text-sm">15230 Frankfurt</p>
                  <p className="text-muted-foreground text-sm mb-3">Deutschland</p>
                  <p className="text-muted-foreground leading-relaxed">
                    Pour toute question concernant vos données : <strong>privacy@frsitesdeparissportifs.com</strong>
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-accent/10 border-l-4 border-accent p-4 mt-4 rounded">
                  <p className="text-sm text-muted-foreground">
                    ...
                    <a href="mailto:privacy@frsitesdeparissportifs.com" className="text-primary hover:underline">
                      privacy@frsitesdeparissportifs.com
                    </a>
              ...
              <section className="bg-primary/5 p-6 rounded-lg border-2 border-primary">
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p className="leading-relaxed">
                    Pour toute question concernant cette politique de confidentialité ou pour exercer vos droits, contactez le responsable du traitement :
                  </p>
                  <div className="space-y-2">
                    <p><strong>Sigmastart04 GmbH</strong></p>
