...
export const metadata: Metadata = {
  title: "Guide des Sports - frsitesdeparissportifs",
  description:
    "Sports populaires en France, tournois majeurs et règles. Guide pour les paris sportifs. 18+ - Jeu responsable.",
  robots: { index: true, follow: true },
  alternates: { canonical: "/sports" },
  openGraph: {
    title: "Guide des Sports - frsitesdeparissportifs",
    description: "Guide des sports, tournois et règles pour les paris sportifs en France.",
    url: "https://frsitesdeparissportifs.com/sports",
  },
}
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
        <div className="container mx-auto max-w-[1200px] px-4 py-16">
          <h1 className="text-4xl font-bold mb-4 text-center text-teal-900">Guide des Sports</h1>
          <p className="text-center text-teal-700 mb-12 max-w-3xl mx-auto">
          ...
          <div className="space-y-12">
            {/* Football */}
            <section className="bg-white rounded-lg shadow-md p-8 border border-teal-200">
              <h2 className="text-3xl font-bold mb-4 text-teal-600">Football</h2>
              <div className="space-y-4 text-teal-800">
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Présentation</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Tournois Majeurs</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Règles Essentielles</h3>
                  <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            {/* Tennis */}
            <section className="bg-white rounded-lg shadow-md p-8 border border-teal-200">
              <h2 className="text-3xl font-bold mb-4 text-teal-600">Tennis</h2>
              <div className="space-y-4 text-teal-800">
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Présentation</h3>
                  <p className="leading-relaxed">
            ...
            {/* Basketball */}
            <section className="bg-white rounded-lg shadow-md p-8 border border-teal-200">
              <h2 className="text-3xl font-bold mb-4 text-teal-600">Basketball</h2>
              <div className="space-y-4 text-teal-800">
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Présentation</h3>
                  <p className="leading-relaxed">
            ...
            {/* Rugby */}
            <section className="bg-white rounded-lg shadow-md p-8 border border-teal-200">
              <h2 className="text-3xl font-bold mb-4 text-teal-600">Rugby</h2>
              <div className="space-y-4 text-teal-800">
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Présentation</h3>
                  <p className="leading-relaxed">
            ...
            {/* Courses Hippiques */}
            <section className="bg-white rounded-lg shadow-md p-8 border border-teal-200">
              <h2 className="text-3xl font-bold mb-4 text-teal-600">Courses Hippiques</h2>
              <div className="space-y-4 text-teal-800">
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Présentation</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Courses Majeures</h3>
                  <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Types de Paris</h3>
                  <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            {/* Handball */}
            <section className="bg-white rounded-lg shadow-md p-8 border border-teal-200">
              <h2 className="text-3xl font-bold mb-4 text-teal-600">Handball</h2>
              <div className="space-y-4 text-teal-800">
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Présentation</h3>
                  <p className="leading-relaxed">
            ...
            {/* Cyclisme */}
            <section className="bg-white rounded-lg shadow-md p-8 border border-teal-200">
              <h2 className="text-3xl font-bold mb-4 text-teal-600">Cyclisme</h2>
              <div className="space-y-4 text-teal-800">
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Présentation</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-teal-900">Classifications</h3>
                  <ul className="list-disc list-inside space-y-1 ml-4">
