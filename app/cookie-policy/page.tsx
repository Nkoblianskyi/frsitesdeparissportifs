...
export const metadata: Metadata = {
  title: "Politique des Cookies - frsitesdeparissportifs",
  description:
    "Comment frsitesdeparissportifs utilise les cookies. 18+ - Jouez responsable.",
  robots: {
    index: true,
    follow: true,
  },
      ...
      <div className="min-h-screen bg-background py-12 md:py-16">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-10">
            ...
            <section className="bg-primary/5 p-4 rounded-lg border-l-4 border-primary mb-8">
              <p className="text-muted-foreground text-sm leading-relaxed">
                Ce site (frsitesdeparissportifs.com) est la propriété de et est géré par <strong>Sigmastart04 GmbH</strong>, Zehmeplatz 14, 15230 Frankfurt, Deutschland.
              </p>
            </section>
            ...
            <div className="space-y-8 text-foreground">
              ...
              <section className="bg-primary/5 p-6 rounded-lg border-2 border-primary">
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  Pour toute question concernant notre utilisation des cookies ou pour exercer vos droits, contactez l'éditeur du site :
                </p>
                <div className="space-y-2 text-muted-foreground">
                  ...
                  <p>
                    <strong>Email :</strong>{" "}
                    <a href="mailto:cookies@frsitesdeparissportifs.com" className="text-primary hover:underline">
                      cookies@frsitesdeparissportifs.com
                    </a>
                  </p>
                </div>
              </section>
