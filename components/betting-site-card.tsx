...
export function BettingSiteCard({ site, rank }: BettingSiteCardProps) {
  ...
  const getBadgeColor = (badge: string) => {
    switch (badge) {
      ...
      case "POPULAIRE":
        return "bg-gradient-to-br from-teal-600 to-teal-700"
      case "TENDANCE":
    ...
    <div
      className={`relative overflow-hidden transition-all duration-500 hover:scale-[1.02] ${
        isFirstItem
          ...
          : "bg-white/90 backdrop-blur-sm border border-gray-200/50 shadow-xl hover:shadow-2xl rounded-lg hover:border-teal-200"
      }`}
    >
      {badgeText && (
      ...
      <div className="p-5 sm:p-7">
        ...
        <div className="hidden lg:grid lg:grid-cols-[auto_auto_1fr_auto_auto_auto] lg:gap-6 lg:items-center">
          ...
          <div className="text-center flex-shrink-0 px-5">
            <div className="text-5xl font-black bg-gradient-to-br from-teal-600 via-teal-700 to-teal-900 bg-clip-text text-transparent">
        ...
        <div className="hidden md:grid lg:hidden md:grid-cols-[auto_1fr_auto] md:gap-5 md:items-center">
          ...
          <div className="flex items-center justify-center md:col-span-1">
            <div className="text-4xl font-black bg-gradient-to-br from-teal-600 via-teal-700 to-teal-900 bg-clip-text text-transparent">
              {site.rating.toFixed(1)}
            </div>
          </div>
        ...
        <div className="md:hidden space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2 items-center py-3 border-t-2 border-slate-100">
            ...
            <div className="flex items-center justify-center">
              <div className="text-3xl font-black bg-gradient-to-br from-teal-600 via-teal-700 to-teal-900 bg-clip-text text-transparent">
                {site.rating.toFixed(1)}
              </div>
            </div>
